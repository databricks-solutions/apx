...
// ── Full HTTP request test ──────────────────────────────────────────────

#[tokio::test]
async fn request_succeeds_with_telemetry_instrumentation() {
    setup();
...
"#;
    ...
    let mut server = super::TestServer::start(app, "_apx_test_telemetry_http").await;
