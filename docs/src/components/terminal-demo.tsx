 ...
 const lines = [
   ...
   { text: "Would you like to set up AI assistant rules? yes", className: "text-cyan-300" },
   { text: "Which assistant would you like to use?: cursor", className: "text-cyan-300" },
   { text: "Which layout would you like to use?: sidebar", className: "text-cyan-300" },
