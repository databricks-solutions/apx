...
| `tracing`    | Tracing OTEL collector commands   |
...
<Callout type="info">
  **Note:** You typically don't need to use tracing commands directly. When you run
  `apx dev start`, apx automatically starts the log collector and keeps it
  running alongside your development servers. The tracing commands are provided for
